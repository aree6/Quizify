  ...
  it('TC009_01: returns full analytics when submissions exist', async () => {
    ...
    vi.mocked(getCourseAnalytics).mockResolvedValue({
      ...
      scoreDistribution: [
        ...
        { range: '21-40%', min: 21, max: 40, count: 1 },
        { range: '41-60%', min: 41, max: 60, count: 2 },
        { range: '61-80%', min: 61, max: 80, count: 3 },
        { range: '81-100%', min: 81, max: 100, count: 3 },
      ],
      topicPerformance: [
        { topic: 'Testing', subtopic: '', totalAnswers: 3, correctCount: 2, percentage: 75 },
        { topic: 'SDLC', subtopic: '', totalAnswers: 2, correctCount: 1, percentage: 65 },
      ],
      bloomPerformance: [
        { bloomLevel: 'understand', totalAnswers: 3, correctCount: 2, percentage: 78 },
        { bloomLevel: 'apply', totalAnswers: 2, correctCount: 1, percentage: 62 },
      ],
      soloPerformance: [
        { soloLevel: 'multistructural', totalAnswers: 3, correctCount: 2, percentage: 75 },
        { soloLevel: 'relational', totalAnswers: 2, correctCount: 1, percentage: 60 },
      ],
      crossMatrix: [],
      questionAnalytics: [],
      studentAnalytics: [],
